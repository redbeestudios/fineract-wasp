...
public interface SelfBeneficiariesRBTPTReadPlatformService {

    Collection<SelfBeneficiariesRBTPTData> retrieveAll();

    Collection<SelfAccountRBTemplateData> retrieveTPTSelfAccountTemplateData(AppUser user);
