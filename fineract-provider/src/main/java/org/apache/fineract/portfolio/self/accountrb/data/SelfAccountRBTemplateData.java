...
public class SelfAccountRBTemplateData implements Comparable<SelfAccountRBTemplateData> {
    ...
    @Override
    public int compareTo(final SelfAccountRBTemplateData obj) {
        if (obj == null) {
            return -1;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof SelfAccountRBTemplateData)) {
            return false;
        }
        final SelfAccountRBTemplateData rhs = (SelfAccountRBTemplateData) obj;
